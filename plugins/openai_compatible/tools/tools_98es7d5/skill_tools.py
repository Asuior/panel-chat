...
from plugins.openai_compatible.skill_loader import list_skills as _list_skills
from plugins.openai_compatible.skill_loader  import load_skill as _load_skill
