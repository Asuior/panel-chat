...
def chat(messages: list, temperature: float = 0.7, extra_body: dict | None = None) -> str:
    ...
    model = str(pick("model", "EXAMPLE_PROVIDER_MODEL", "Qwen/Qwen3.8-27B"))
    base_url = str(pick("base_url", "EXAMPLE_PROVIDER_BASE_URL", "https://api-inference.modelscope.cn/v1"))
